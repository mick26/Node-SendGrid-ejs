...
.controller('MainCtrl', function($scope, $log, emailService, $location, $sce, 
			$rootScope, $mdDialog, $mdToast, $animate, $q) {
	...
	$scope.emptyFormObj = { email: {"to":'', "from":'', 
		"subject":'', "text":''} };
...
/*	Works but no need for close button in template as clicking 
...
*/ 
	    ...
	    function(error) {
	    	$log.error("Problem with previewEmail" + error);
